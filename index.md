...
GENUARY happens on all the social media sites at once, including the one that your weird aunt/uncle uses (tell them I said hi). If you like, you can use hashtags to keep track of things: share your work and tag it with **#genuary** and **#genuary2026** and also **#genuary1**, **#genuary2**, etc, depending on which prompt it is. 
...
We have curated the 31 absolute finest prompts for you personally. They have been radically scrutinized for ultimate creative purposes.
...
<script>
  ...
  arewethereyet.innerHTML = [
    "It's almost 2026 and GENUARY emerges!",
    "It's 2026 and GENUARY emerges!",
    "Once upon a time, it was 2026 and GENUARY emerged!",
  ][Math.sign(MAGIC_TIME_INDEX - 2026) + 1];
</script>
